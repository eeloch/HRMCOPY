...
urlpatterns = [
    ...
    path("shift-plans/", ShiftPlanListAPIView.as_view(), name="shift-plans"),
    path("shift-plans/assign/", ShiftPlanAssignAPIView.as_view(), name="shift-plans-assign"),
    path("shift-plans/<int:plan_id>/flip-week/", ShiftPlanFlipAPIView.as_view(), name="shift-plan-flip-week"),
    path("shift-roster/template/", ShiftRosterTemplateAPIView.as_view(), name="shift-roster-template"),
    path("shift-roster/upload/", ShiftRosterUploadAPIView.as_view(), name="shift-roster-upload"),
    path("shift-plans/for-employee/<int:employee_id>/", EmployeeShiftPlanAPIView.as_view(), name="shift-plan-for-employee"),
