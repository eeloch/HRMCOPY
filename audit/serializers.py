...
class AuditEventSerializer(serializers.ModelSerializer):
    ...
    @staticmethod
    def get_employee_department(audit_event):
        if not audit_event.employee or not audit_event.employee.department_id:
            return None

        return audit_event.employee.department.name
